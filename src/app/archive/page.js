    ...
    <>
      ...
      <div className='pt-[5rem] px-vw lg:pt-[20vh] h-full '>
        ...
        {trail.map(({ width, ...style }, index) => {
          ...
          return (
            <>
              <a.div key={index} className='h-[1px] bg-gray dark:bg-amber opacity-40' style={{ width }}></a.div>
              {/* DIVIDER ROW */}
              <div ref={ref} className='cursor-pointer py-[2.5vw] md:py-[2vw] lg:py-[19px] font-[300] text-[2.3vw] md:text-[1.8vw] lg:text-[14px]'>
                <Animated show={onActive}>
